...
st.subheader("Welcome to the FrontEnd Interface")

sch = 0
SNR = 0
corr = 0
constant_fk2d= st.number_input("Enter value for constant_fk2d : ",min_value=0.01)
multiplying_factor_3d=st.number_input("Enter value for multiplying_factor_3d : ",min_value=0.01)
Shear_velocity=st.number_input("Enter value for Shear_velocity : ",min_value=0.01)

st.write("Filtering methods :")
st.write("1. C")
st.write('2. S')
st.write('3. A')
st.write('4. C & S')
...
tch = st.number_input(label="Choose Filtering method from above options and press enter: " , min_value=1 , max_value = 8)


if tch == 1:
    corr = st.number_input("Enter threshold value for C : ",min_value=0.01)
elif tch == 2:
    SNR = st.number_input("Enter threshold value for S : ",min_value=0.01)
elif tch == 3:
    Lambda = st.number_input("Enter Lambda value for A : ",min_value=0.01)
    k = st.number_input("Enter k value for A : ",min_value=0.01)
elif tch == 4:
    corr = st.number_input("Enter threshold value for C : ",min_value=0.01)
    SNR = st.number_input("Enter threshold value for S : ",min_value=0.01)
elif tch == 5:
...
sch = st.number_input("Enter replacement method from above options : " , min_value=1 , max_value=7)
